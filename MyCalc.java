...
class MyCalc extends WindowAdapter implements ActionListener {
    ...
    Button badd, bsub, bmult, bdiv, bmod, bclc, bclr, bpts, bneg, bback;
    double xd;
